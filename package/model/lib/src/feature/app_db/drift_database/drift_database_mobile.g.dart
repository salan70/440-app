...
part of 'drift_database_mobile.dart';
...
class $TotalBattingStatsTable extends TotalBattingStats
    with TableInfo<$TotalBattingStatsTable, TotalBattingStat> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TotalBattingStatsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _playerIdMeta =
      const VerificationMeta('playerId');
  @override
  late final GeneratedColumn<String> playerId = GeneratedColumn<String>(
      'playerId', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _finalYearMeta =
      const VerificationMeta('finalYear');
  @override
  late final GeneratedColumn<int> finalYear = GeneratedColumn<int>(
      'finalYear', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _finalTeamIdMeta =
      const VerificationMeta('finalTeamId');
  @override
  late final GeneratedColumn<String> finalTeamId = GeneratedColumn<String>(
      'finalTeamId', aliasedName, false,
      additionalChecks:
          GeneratedColumn.checkTextLength(minTextLength: 1, maxTextLength: 50),
      type: DriftSqlType.string,
      requiredDuringInsert: true);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'totalBattingStats';
  @override
  VerificationContext validateIntegrity(Insertable<TotalBattingStat> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('playerId')) {
    ...
    if (data.containsKey('finalYear')) {
      context.handle(_finalYearMeta,
          finalYear.isAcceptableOrUnknown(data['finalYear']!, _finalYearMeta));
    } else if (isInserting) {
      context.missing(_finalYearMeta);
    }
    if (data.containsKey('finalTeamId')) {
      context.handle(
          _finalTeamIdMeta,
          finalTeamId.isAcceptableOrUnknown(
              data['finalTeamId']!, _finalTeamIdMeta));
    } else if (isInserting) {
      context.missing(_finalTeamIdMeta);
    }
    if (data.containsKey('G')) {
      context.handle(
          _gamesMeta, games.isAcceptableOrUnknown(data['G']!, _gamesMeta));
  ...
  Set<GeneratedColumn> get $primaryKey => {playerId};
  @override
  TotalBattingStat map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TotalBattingStat(
      playerId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}playerId'])!,
      finalYear: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}finalYear'])!,
      finalTeamId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}finalTeamId'])!,
      games: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}G'])!,
      plateAppearances: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}PA'])!,
  ...
  @override
  $TotalBattingStatsTable createAlias(String alias) {
    return $TotalBattingStatsTable(attachedDatabase, alias);
  }
}

class TotalBattingStat extends DataClass
    implements Insertable<TotalBattingStat> {
  final String playerId;
  final int finalYear;
  ...
  final double? walkPercentage;
  final double? strikeoutPercentage;
  const TotalBattingStat(
      {required this.playerId,
      required this.finalYear,
      required this.finalTeamId,
      required this.games,
      required this.plateAppearances,
      required this.atBats,
      required this.hits,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['playerId'] = Variable<String>(playerId);
    map['finalYear'] = Variable<int>(finalYear);
    map['finalTeamId'] = Variable<String>(finalTeamId);
    map['G'] = Variable<int>(games);
    map['PA'] = Variable<int>(plateAppearances);
    map['AB'] = Variable<int>(atBats);
    map['H'] = Variable<int>(hits);
  ...
  TotalBattingStatsCompanion toCompanion(bool nullToAbsent) {
    return TotalBattingStatsCompanion(
      playerId: Value(playerId),
      finalYear: Value(finalYear),
      finalTeamId: Value(finalTeamId),
      games: Value(games),
      plateAppearances: Value(plateAppearances),
      atBats: Value(atBats),
      hits: Value(hits),
  ...
  factory TotalBattingStat.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TotalBattingStat(
      playerId: serializer.fromJson<String>(json['playerId']),
      finalYear: serializer.fromJson<int>(json['finalYear']),
      finalTeamId: serializer.fromJson<String>(json['finalTeamId']),
      games: serializer.fromJson<int>(json['games']),
      plateAppearances: serializer.fromJson<int>(json['plateAppearances']),
      atBats: serializer.fromJson<int>(json['atBats']),
      hits: serializer.fromJson<int>(json['hits']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'playerId': serializer.toJson<String>(playerId),
      'finalYear': serializer.toJson<int>(finalYear),
      'finalTeamId': serializer.toJson<String>(finalTeamId),
      'games': serializer.toJson<int>(games),
      'plateAppearances': serializer.toJson<int>(plateAppearances),
      'atBats': serializer.toJson<int>(atBats),
      'hits': serializer.toJson<int>(hits),
  ...
  TotalBattingStat copyWith(
      ...
      TotalBattingStat(
        ...
        finalTeamId: finalTeamId ?? this.finalTeamId,
        games: games ?? this.games,
        plateAppearances: plateAppearances ?? this.plateAppearances,
        atBats: atBats ?? this.atBats,
        hits: hits ?? this.hits,
  ...
  TotalBattingStat copyWithCompanion(TotalBattingStatsCompanion data) {
    return TotalBattingStat(
      playerId: data.playerId.present ? data.playerId.value : this.playerId,
      finalYear: data.finalYear.present ? data.finalYear.value : this.finalYear,
      finalTeamId:
          data.finalTeamId.present ? data.finalTeamId.value : this.finalTeamId,
      games: data.games.present ? data.games.value : this.games,
      plateAppearances: data.plateAppearances.present
          ? data.plateAppearances.value
          : this.plateAppearances,
  ...
  @override
  String toString() {
    return (StringBuffer('TotalBattingStat(')
          ..write('playerId: $playerId, ')
          ..write('finalYear: $finalYear, ')
          ..write('finalTeamId: $finalTeamId, ')
          ..write('games: $games, ')
          ..write('plateAppearances: $plateAppearances, ')
          ..write('atBats: $atBats, ')
          ..write('hits: $hits, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TotalBattingStat &&
          other.playerId == this.playerId &&
          other.finalYear == this.finalYear &&
          other.finalTeamId == this.finalTeamId &&
          other.games == this.games &&
          other.plateAppearances == this.plateAppearances &&
          other.atBats == this.atBats &&
          other.hits == this.hits &&
...
class TotalBattingStatsCompanion extends UpdateCompanion<TotalBattingStat> {
  final Value<String> playerId;
  final Value<int> finalYear;
  final Value<String> finalTeamId;
  final Value<int> games;
  final Value<int> plateAppearances;
  final Value<int> atBats;
  final Value<int> hits;
  ...
  final Value<double?> strikeoutPercentage;
  final Value<int> rowid;
  const TotalBattingStatsCompanion({
    this.playerId = const Value.absent(),
    this.finalYear = const Value.absent(),
    this.finalTeamId = const Value.absent(),
    this.games = const Value.absent(),
    this.plateAppearances = const Value.absent(),
    this.atBats = const Value.absent(),
    this.hits = const Value.absent(),
  ...
  TotalBattingStatsCompanion.insert({
    required String playerId,
    required int finalYear,
    required String finalTeamId,
    required int games,
    required int plateAppearances,
    required int atBats,
    required int hits,
    ...
    this.rowid = const Value.absent(),
        ...
        sacrificeFlies = Value(sacrificeFlies),
        groundedIntoDoublePlays = Value(groundedIntoDoublePlays);
  static Insertable<TotalBattingStat> custom({
    Expression<String>? playerId,
    Expression<int>? finalYear,
    Expression<String>? finalTeamId,
    Expression<int>? games,
    Expression<int>? plateAppearances,
    Expression<int>? atBats,
    Expression<int>? hits,
    ...
    return RawValuesInsertable({
      if (playerId != null) 'playerId': playerId,
      if (finalYear != null) 'finalYear': finalYear,
      if (finalTeamId != null) 'finalTeamId': finalTeamId,
      if (games != null) 'G': games,
      if (plateAppearances != null) 'PA': plateAppearances,
      if (atBats != null) 'AB': atBats,
      if (hits != null) 'H': hits,
  ...
  TotalBattingStatsCompanion copyWith(
      {Value<String>? playerId,
      Value<int>? finalYear,
      Value<String>? finalTeamId,
      Value<int>? games,
      Value<int>? plateAppearances,
      Value<int>? atBats,
      Value<int>? hits,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (finalYear.present) {
      map['finalYear'] = Variable<int>(finalYear.value);
    }
    if (finalTeamId.present) {
      map['finalTeamId'] = Variable<String>(finalTeamId.value);
    }
    if (games.present) {
      map['G'] = Variable<int>(games.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('TotalBattingStatsCompanion(')
          ..write('playerId: $playerId, ')
          ..write('finalYear: $finalYear, ')
          ..write('finalTeamId: $finalTeamId, ')
          ..write('games: $games, ')
...
abstract class _$MyDriftDatabase extends GeneratedDatabase {
  ...
  late final $TotalBattingStatsTable totalBattingStats =
      $TotalBattingStatsTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [players, battingStats, totalBattingStats];
}
...
typedef $$BattingStatsTableProcessedTableManager = ProcessedTableManager<
    ...
    BattingStat,
    PrefetchHooks Function()>;
typedef $$TotalBattingStatsTableCreateCompanionBuilder
    = TotalBattingStatsCompanion Function({
  required String playerId,
  required int finalYear,
  required String finalTeamId,
  required int games,
...
typedef $$TotalBattingStatsTableUpdateCompanionBuilder
    = TotalBattingStatsCompanion Function({
  Value<String> playerId,
  Value<int> finalYear,
  Value<String> finalTeamId,
...
class $$TotalBattingStatsTableFilterComposer
  ...
  ColumnFilters<int> get finalYear => $state.composableBuilder(
      column: $state.table.finalYear,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<String> get finalTeamId => $state.composableBuilder(
      column: $state.table.finalTeamId,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$TotalBattingStatsTableOrderingComposer
  ...
  ColumnOrderings<int> get finalYear => $state.composableBuilder(
      column: $state.table.finalYear,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<String> get finalTeamId => $state.composableBuilder(
      column: $state.table.finalTeamId,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $$TotalBattingStatsTableTableManager extends RootTableManager<
    ...
    $$TotalBattingStatsTableOrderingComposer,
    $$TotalBattingStatsTableCreateCompanionBuilder,
  ...
  $$TotalBattingStatsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$TotalBattingStatsTableFilterComposer(ComposerState(db, table)),
          orderingComposer: $$TotalBattingStatsTableOrderingComposer(
              ComposerState(db, table)),
          updateCompanionCallback: ({
            Value<String> playerId = const Value.absent(),
            Value<int> finalYear = const Value.absent(),
            Value<String> finalTeamId = const Value.absent(),
            Value<int> games = const Value.absent(),
            Value<int> plateAppearances = const Value.absent(),
            Value<int> atBats = const Value.absent(),
            Value<int> hits = const Value.absent(),
...
class $MyDriftDatabaseManager {
  ...
  $$TotalBattingStatsTableTableManager get totalBattingStats =>
      $$TotalBattingStatsTableTableManager(_db, _db.totalBattingStats);
}
